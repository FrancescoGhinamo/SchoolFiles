...
public class GestioneMagazzinoGUI extends JFrame implements ActionListener, ListSelectionListener, Comandi {
	...
	public void initComponents() {
		...
		btnVisualizza = new JButton("Visualizza prodotti nel record");
		...
		ckOrdina = new JCheckBox("Auto-update durante il sorting");
		
		JPanel dataIn = new JPanel();
		dataIn.setLayout(new GridLayout(6, 2, 3, 3));
